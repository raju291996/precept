...
<div class="user-profile-divx">
        <div class="user-profile-div-aside1 profile-divx12">
            ...
            <a href="delete_account.php" class="cp-active">Deactivate Account</a>
        </div>
            ...
            <div class="update-info">
                <form action="delete_account.php" method="post">
                    <div class="account-form-field">
                        <input type="password" name="cur-pass" class="input" placeholder="Type account Password" ><span class="acc-error"><?php echo @$cur_error; ?><?php echo @$inval_error; ?></span>
                    </div>
