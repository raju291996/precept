...
<div class="prae-header">
    <div class="scroll_header2">
	    <div class="scroll_logo3"><a href="home.php" style="text-decoration:none;color:#00a5bb;">PRECEPT</a></div>
        <div class="scroll_nav3"> 
	        <ul>
                <li><a href="index.php">HOME</a></li>
                <li><a href="becometutor.php">BECOME A TUTOR</a></li>
                <li class="dropdown"><a href="account.php" class="dropbtn">Hi <?php echo substr($data['user_name'], 0, 4); ?>&nbsp;<img src="images/drop-down-arrow.png" align="top"/></a>
        ...
        <div class="search">
            <div>
			    <form action="search_result.php" method="post">
                    ...
                    <div class="form f-btn"><input type="button" name="submit" value="Search" class="input-btn"/></div>
                    <div class="clear"></div>
                </form>
